...
*/
/** \file MaskedBlur.cpp
 *  This file is needed for class MaskedBlur to work as a charon plugin.
...
extern "C" maskedblur_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" maskedblur_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
