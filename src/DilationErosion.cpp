 ...
 *  This file is needed for the DilationErosion class to work as a plugin.
...
extern "C" dilationerosion_DECLDIR void destroy(
		ParameteredObject* b) {
	delete b;
}
///Report build configuration to prevent linking of incompatibel runtime libs
extern "C" dilationerosion_DECLDIR ParameteredObject::build_type getBuildType() {
    #ifdef _DEBUG
