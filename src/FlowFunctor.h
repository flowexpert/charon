...
class FlowFunctor : public FlowFunctorInterface
{
private:
...
public:
	/// default constructor
	FlowFunctor() {}
	//FlowFunctor(float a1, float a2, float b11, float b12, float b21, float b22, float c1, float c2);
	...
	* @f]
	*/
	void setParams(const float a1, const float a2, const float b11, const float b12, const float b21, const float b22,
	 ...
	 *		\left( \begin{array}{ccc} b_{11} & b_{12} & b_{13}  \\ b_{21} & b_{22} & b_{23} \\
	 ...
	 * @f]
	 */		
	void setParams3d(const float a1, const float a2, const float a3, const float b11, const float b12, const float b13,
			  const float b21, const float b22, const float b23, const float b31, const float b32,
      			  const float b33, const float c1, const float c2, const float c3);
	/**
	 ...
	 * @param[out] f array in which flow is returned
	 */
	virtual void get3d(const float x, const float y, const float z, float* f) const;
