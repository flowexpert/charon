...
*/
template <class T>
class motionmodels_localrotation_DECLDIR LocalRotation : public MotionModel
{
private:
...
public:
	...
	//virtual void update() {is3d = !(dx().is_sameN(1));}
	 ...
	 * 
	 */
	void setFlowFunctorParams(const float a1, const float a2, const float a3, const float s1, const float s2,
