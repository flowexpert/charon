...
virtual std::set<std::string>& LocalAffiness::getUnknowns()
{
...
template <class T>
void LocalAffiness::compute(const int xs, const int ys, const int zs,
...
LocalAffiness::LocalAffiness(const string& name) 
		: flowfunc() , MotionModel("motionmodels_localaffiness",name)
{
...
void LocalAffiness::setFlowFunctorParams(	const float a1, const float a2, const float a3,
...
{
	flowfunc.setParams3d(a1,a2,a3,b11,b12,b13,b21,b22,b23,b31,b32,b33,0.0,0.0,0.0);
}
