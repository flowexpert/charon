...
protected:
	...
	void _update() {std::cout << "momoUpdate"<< std::endl; /*_outDataChanged(out);*/ }
...
public:
		...
		ParameteredObject(classname,name,"computes the vectors")
	{
		...
		_addOutputSlot(flowFunctor, "flowfunctor", "flowFunctor of MotionModel", "FlowFunctorInterface*");
