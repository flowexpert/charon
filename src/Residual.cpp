...
*/
/** \file Residual.cpp
 *  This file is needed for the Residual class to work as a plugin.
...
extern "C" residual_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" residual_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
