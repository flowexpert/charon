...
*/
/** \file IrlsNonLocal.cpp
 *  This file is needed for the IrlsNonLocal class to work as a plugin.
...
extern "C" irlsnonlocal_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" irlsnonlocal_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
