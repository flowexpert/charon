...
*/
/** \file GetRoi.cpp
 *  This file is needed for class GetRoi to work as a plugin.
...
#include <charon-utils/GetRoi.hxx>
#include <charon-utils/DataManagerCImgList.hxx>

/// Creates an instance of the plugin
extern "C" getroi_DECLDIR ParameteredObject* create(
...
extern "C" getroi_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" getroi_DECLDIR
