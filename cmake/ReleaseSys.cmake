...
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "charon plugin management and core utilities")
...
SET(CPACK_PACKAGE_INSTALL_DIRECTORY		"charon")
...
# Descriptions
SET(CPACK_COMPONENT_LIBRARIES_DESCRIPTION "libraries to link external projects against ${PROJECT_NAME}")
SET(CPACK_COMPONENT_HEADERS_DESCRIPTION "header files for library usage")
...
SET(CPACK_COMPONENT_GROUP_DEVELOPMENT_DESCRIPTION "Tools you need to develop software that uses ${PROJECT_NAME}")
...
IF(ENABLE_DOC)
    ...
    SET(CPACK_COMPONENT_HTMLDOC_DESCRIPTION "HTML Documentation (including API doc)")
    SET(CPACK_COMPONENT_HTMLDOC_GROUP "Documentation")
    SET(CPACK_COMPONENT_GROUP_DOCUMENTATION_DESCRIPTION "doxygen generated manual and api documentation")
    ...
    IF(LATEX_COMPILER)
        ...
        SET(CPACK_COMPONENT_PDFDOC_DESCRIPTION "PDF Documentation (without API doc)")
