...
/// Needed for class ImageRotation to work as charon plugin.
/// \author <a href="mailto:michael.baron@iwr.uni-heidelberg.de">
///   Michael Baron</a>
/// \date 11.02.2013

#include <charon/ImageRotation.hxx>

/// Class name of the plugin
#define TYPE ImageRotation

/// Creates an instance of the plugin
extern "C" imagerotation_DECLDIR
...
extern "C" imagerotation_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
