...
*/
/** \file FlowComparator.cpp
 *  This file is needed for class FlowComparator to work as a plugin.
...
extern "C" flowcomparator_DECLDIR ParameteredObject* create(
...
extern "C" flowcomparator_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" flowcomparator_DECLDIR
