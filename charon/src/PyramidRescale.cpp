...
*/
/** \file PyramidRescale.cpp
 *  This file is needed for class PyramidRescale to work as a plugin.
...
extern "C" pyramidrescale_DECLDIR ParameteredObject* create(
...
extern "C" pyramidrescale_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" pyramidrescale_DECLDIR
