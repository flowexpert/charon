...
*/
/** \file CGSolverHelper.cpp
 *  This file is needed for class WarpingCGSolverHelper to work as a plugin.
...
extern "C" cgsolverhelper_DECLDIR void destroy(ParameteredObject* b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" cgsolverhelper_DECLDIR
