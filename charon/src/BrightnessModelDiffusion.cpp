...
*/
/** \file Diffusion.cpp
 *  This file is needed for class Diffusion to work as a charon plugin.
...
#include <charon/BrightnessModels/Diffusion.hxx>
...
extern "C" brightnessmodels_diffusion_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" brightnessmodels_diffusion_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
