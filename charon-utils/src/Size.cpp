...
*/
/** \file Size.cpp
 *  This file is needed for class Size to work as a charon plugin.
...
extern "C" size_DECLDIR ParameteredObject* create(
...
extern "C" size_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" size_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
