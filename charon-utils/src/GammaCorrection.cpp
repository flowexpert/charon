 ...
 *  This file is needed for class GammaCorrection to work as a plugin.
...
extern "C" gammacorrection_DECLDIR ParameteredObject* create(
...
extern "C" gammacorrection_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
