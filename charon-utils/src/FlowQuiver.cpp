...
*/
/// \file FlowQuiver.cpp
/// Needed for class FlowQuiver to work as charon plugin.
...
#define TYPE FlowQuiver

/// Creates an instance of the plugin
extern "C" flowquiver_DECLDIR
...
extern "C" flowquiver_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
