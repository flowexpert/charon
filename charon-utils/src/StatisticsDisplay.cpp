...
*/
/** \file StatisticsDisplay.cpp
 *  This file is needed for class StatisticsDisplay to work as a plugin.
...
extern "C" statisticsdisplay_DECLDIR ParameteredObject* create(
