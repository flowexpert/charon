...
*/
/** \file ArgosDisplay.cpp
 *  This file is needed for class ArgosDisplay to work as a plugin.
...
extern "C" argosdisplay_DECLDIR ParameteredObject* create(
...
extern "C" argosdisplay_DECLDIR void destroy(ParameteredObject * b) {
	delete b;
}

/// Report build configuration to prevent linking of incompatibel runtime libs
extern "C" argosdisplay_DECLDIR ParameteredObject::build_type getBuildType() {
#ifdef _DEBUG
